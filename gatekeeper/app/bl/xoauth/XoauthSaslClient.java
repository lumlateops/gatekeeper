...
class XoauthSaslClient implements SaslClient
{
	 ...
	 */
	public XoauthSaslClient(XoauthProtocol protocol, String oauthToken,
			String oauthTokenSecret, String consumerKey, String consumerSecret,
	...
	public byte[] evaluateChallenge(byte[] challenge) throws SaslException
	{
		...
		try
		{
			byte[] rv = responseBuilder.buildResponse(email, protocol, oauthToken,
