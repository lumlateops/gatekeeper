 ...
 * <p>
 * Only the "XOAUTH" mechanism is supported. Only the "imaps" protocol is
...
public class XoauthSaslClientFactory implements SaslClientFactory
{
			...
			Map<String, ?> props, CallbackHandler callbackHandler)
	{
		...
		return new XoauthSaslClient(xoauthProtocol, (String) props
				.get(OAUTH_TOKEN_PROP), (String) props.get(OAUTH_TOKEN_SECRET_PROP),
				(String) props.get(CONSUMER_KEY_PROP), (String) props
						.get(CONSUMER_SECRET_PROP), callbackHandler);
	}
