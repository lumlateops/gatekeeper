 ...
 */
public class GmailXOAuthAuthenticator
{
  ...
  private static final String CONSUMER_SECRET = "f_yk4d2GkQljJ38JQrcRJBPr";
	...
	{
		return new OAuthConsumer(null, CONSUMER_KEY, CONSUMER_SECRET, null);
	}
	 ...
	 * @param userEmail
	 *          Email address of the user to authenticate, for example {@code
	 *          xoauth@gmail.com}.
	 * @param oauthToken
	 ...
	 * @param consumer
	 *          The application's OAuthConsumer. For testing, use {@code
	...
	public static void main(String args[]) throws Exception
	{
		...
		{
			System.err
					.println("Usage: XoauthAuthenticator <email> <oauthToken> <oauthTokenSecret>");
			return;
		}
		String email = args[0];
		...
		IMAPSSLStore imapSslStore = connectToImap("imap.googlemail.com", 993,
				email, oauthToken, oauthTokenSecret, getAnonymousConsumer(), true);
